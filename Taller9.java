...
public class Taller9 {
    ...
    public static void main(String[] args) {
        Taller9 t9=new Taller9();
        System.out.println("Casa y Calle: "+t9.levenshtein("Casa","Calle")); 
        System.out.println("Casa y \"\": "+t9.levenshtein("Casa",""));
        System.out.println("Alejandro y Sebastián: "+t9.levenshtein("Alejandro","Sebastián"));
    }
